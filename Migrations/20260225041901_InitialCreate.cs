    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservacionesCanchas", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Membresias_FechaFin_Estado",
                table: "Membresias",
                columns: new[] { "FechaFin", "Estado" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservaciones_FechaInicio_Estado",
                table: "ReservacionesCanchas",
                columns: new[] { "FechaHoraInicio", "Estado" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservacionesCanchas_UsuarioId",
                table: "ReservacionesCanchas",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Usuarios_Nombre_Apellido",
                table: "Usuarios",
